...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('funcionarios', function (Blueprint $table) {
            ...
            $table->boolean('bater_ponto')->default(0);

            $table->integer('carga_horaria_mensal')->nullable();
            $table->decimal('valor_hora_extra', 10,2)->nullable();
            ...
            // alter table funcionarios add column bater_ponto boolean default 1;

            // alter table funcionarios add column carga_horaria_mensal integer default null;
            // alter table funcionarios add column valor_hora_extra decimal(10,2) default null;
