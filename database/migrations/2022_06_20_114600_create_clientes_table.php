...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('clientes', function (Blueprint $table) {
            ...
            $table->enum('score_categoria', ['ouro','prata','bronze'])->default('bronze');
            $table->decimal('score_limite_credito', 12, 2)->default(0);

            // alter table clientes add column imagem varchar(25) default null;
            // alter table clientes add column asaas_id varchar(100) default null;
