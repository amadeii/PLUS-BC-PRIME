...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('mdves', function (Blueprint $table) {
            ...
            $table->string('cep_carrega', 9)->defaul('');
            $table->string('cep_descarrega', 9)->defaul('');
            ...
            // alter table mdves modify column cep_carrega varchar(9) default '';
            // alter table mdves modify column cep_descarrega varchar(9) default '';
