...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('conta_boletos', function (Blueprint $table) {
            ...
            // alter table conta_boletos add column instrucoes varchar(255) default null;
            // alter table conta_boletos add column posto varchar(10) default null;
            // alter table conta_boletos add column ultimo_numero integer default 0;
