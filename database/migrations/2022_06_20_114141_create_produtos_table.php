...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('produtos', function (Blueprint $table) {
            ...
            $table->boolean('lancar_produtos_combo')->default(0);
            ...
            $table->decimal('perc_glp', 7,4)->default(0);
            $table->decimal('perc_gnn', 7,4)->default(0);
            $table->decimal('perc_gni', 7,4)->default(0);
            ...
            $table->decimal('perc_red_bc_ibs', 10,2)->default(0);

            $table->boolean('tag_veiculo_fiscal')->default(0);
            $table->integer('tpOp')->nullable();
            $table->string('chassi', 17)->nullable();
            $table->string('cCor', 4)->nullable();
            $table->string('xCor', 40)->nullable();
            $table->integer('pot')->nullable();
            $table->integer('cilin')->nullable();
            $table->decimal('pesoL', 12, 4)->nullable();
            $table->decimal('pesoB', 12, 4)->nullable();
            $table->string('nSerie', 9)->nullable();
            $table->string('tpComb', 2)->nullable();
            $table->string('nMotor', 21)->nullable();
            $table->decimal('CMT', 12, 4)->nullable();
            $table->decimal('dist', 12, 4)->nullable();
            $table->integer('anoMod')->nullable();
            $table->integer('anoFab')->nullable();
            $table->string('tpPint', 2)->nullable();
            $table->string('tpVeic', 2)->nullable();
            $table->integer('espVeic')->nullable();
            $table->string('VIN', 2)->nullable();
            $table->integer('condVeic')->nullable();
            $table->integer('cMod')->nullable();
            $table->integer('cCorDENATRAN')->nullable();
            $table->integer('lota')->nullable();
            $table->integer('tpRest')->nullable();

            // alter table produtos modify column perc_glp decimal(7,4) default 0;
            // alter table produtos modify column perc_gnn decimal(7,4) default 0;
            // alter table produtos modify column perc_gni decimal(7,4) default 0;

            // alter table produtos add column tag_veiculo_fiscal boolean default 0;
            // alter table produtos add column tpOp integer default null;
            // alter table produtos add column chassi varchar(17) default null;
            // alter table produtos add column cCor varchar(4) default null;
            // alter table produtos add column xCor varchar(40) default null;
            // alter table produtos add column pot integer default null;
            // alter table produtos add column cilin integer default null;
            // alter table produtos add column pesoL decimal(12, 4) default null;
            // alter table produtos add column pesoB decimal(12, 4) default null;
            // alter table produtos add column nSerie varchar(9) default null;
            // alter table produtos add column tpComb varchar(9) default null;
            // alter table produtos add column nMotor varchar(9) default null;
            // alter table produtos add column CMT decimal(12, 4) default null;
            // alter table produtos add column dist decimal(12, 4) default null;
            // alter table produtos add column anoMod integer default null;
            // alter table produtos add column anoFab integer default null;
            // alter table produtos add column tpPint varchar(2) default null;
            // alter table produtos add column tpVeic varchar(2) default null;
            // alter table produtos add column espVeic integer default null;
            // alter table produtos add column VIN varchar(2) default null;
            // alter table produtos add column condVeic integer default null;
            // alter table produtos add column cMod integer default null;
            // alter table produtos add column cCorDENATRAN integer default null;
            // alter table produtos add column lota integer default null;
            // alter table produtos add column tpRest integer default null;
            ...
            // alter table produtos add column lancar_produtos_combo boolean default 0;
            ...
            // alter table produtos add column codigo_interno varchar(30) default null;
