...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('padrao_tributacao_produtos', function (Blueprint $table) {
            ...
            $table->decimal('perc_ibs_uf', 10,2)->nullable();
            $table->decimal('perc_ibs_mun', 10,2)->nullable();
            $table->decimal('perc_cbs', 10,2)->nullable();
            $table->decimal('perc_dif', 10,2)->nullable();
