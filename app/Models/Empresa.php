...
class Empresa extends Model
{
    ...
    protected $fillable = [
        ...
        'substituto_tributario', 'wallet_id', 'dominio', 'logo_login', 'logo_sidebar', 'nome_sistema', 'telefone_suporte', 'whatsapp_suporte',
        'email_suporte', 'site'
    ];
    ...
    public function getLogoSidebarAttribute($value)
    {
        if (empty($value)) {
            return '/logo-sm.png';
        }

        return '/uploads/white-label/' . $value;
    }
    ...
    public function contadorEmpresa(){
        return $this->hasOne(ContadorEmpresa::class, 'empresa_id');
    }
