...
class ContaReceber extends Model
{
    ...
    protected $fillable = [
        ...
        'plano_conta_id', 'valor_multa', 'valor_juros', 'numero_sequencial', 'conta_receber_origem_id'
    ];
    ...
    public function historicoRecebimento()
    {
        if($this->conta_receber_origem_id) return 1;
        return ContaReceber::where('conta_receber_origem_id', $this->id)->exists();
        return 0;
    }
    ...
    {
        return $this->hasOne(CobrancaBancaria::class, 'conta_receber_id');
    }
