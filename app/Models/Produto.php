...
class Produto extends Model
{
	...
	protected $fillable = [
		...
		'tpOp', 'chassi', 'cCor', 'xCor','pot','cilin','pesoL','pesoB','nSerie','tpComb','nMotor','CMT','dist','anoMod','anoFab','tpPint',
		'tpVeic','espVeic','VIN','condVeic','cMod','cCorDENATRAN','lota','tpRest', 'tag_veiculo_fiscal', 'lancar_produtos_combo', 'codigo_interno',
		'materia_prima'
	];
	...
	{
		return $this->hasOne(RoteiroProducao::class, 'produto_id');
	}
	...
	public function estoqueAtualProduto(){
		return $this->hasOne(EstoqueAtualProduto::class, 'produto_id');
	}
	...
	{
		return $this->hasOne(RotinaFabricacao::class, 'produto_id');
	}
	...
	public function adicionaisMobile(){
		return $this->hasMany(ProdutoAdicional::class, 'produto_id')->with('adicional');
	}
