...
class PlanejamentoCusto extends Model
{
    ...
    public function _estado(){
        if($this->estado == 'novo'){
            ...
            return "<h5 class='badge bg-primary text-white'>PROPOSTA</h5>";
        }else if($this->estado == 'cotacao'){
            return "<h5 class='badge bg-info text-white'>COTAÇÃO</h5>";
        }else if($this->estado == 'producao'){
            return "<h5 class='badge bg-dark text-white'>PRODUÇÃO</h5>";
        }else if($this->estado == 'cancelado'){
            return "<h5 class='badge bg-danger text-white'>CANCELADO</h5>";
        }else{
            return "<h5 class='badge bg-success text-white'>FINALIZADO</h5>";
        }
    }
}
