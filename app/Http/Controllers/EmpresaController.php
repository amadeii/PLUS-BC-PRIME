...
class EmpresaController extends Controller
{
    ...
    private function deleteRegistros($empresa_id){
        ...
        \App\Models\CategoriaAcomodacao::where('empresa_id', $empresa_id)->delete();
        \App\Models\Acomodacao::where('empresa_id', $empresa_id)->delete();
        ...
        $frigo = \App\Models\Frigobar::where('empresa_id', $empresa_id)->get();
        foreach($frigo as $n){
            $n->padraoProdutos()->delete();
            $n->delete();
        }
