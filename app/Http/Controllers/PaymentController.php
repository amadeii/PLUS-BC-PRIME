...
class PaymentController extends Controller
{
    ...
    public function asaas($id){
        ...
        $contador = optional(optional($empresa->contadorEmpresa)->contador);

        if ($contador && $contador->wallet_id && $contador->percentual_comissao > 0) {
            $dataPix["split"] = [
                [
                    "walletId" => $contador->wallet_id,
                    "percentualValue" => (float) $contador->percentual_comissao
                ]
            ];
        }
