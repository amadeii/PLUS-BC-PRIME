...
class VendaController extends Controller
{
    public function index(Request $request){
        ...
        ->select('nves.id', 'cliente_id', 'user_id', 'nves.funcionario_id as funcionario_id', 'total', 'desconto', 'acrescimo', 'numero_serie', 'nves.numero',
        ...
        ->select('nfces.id', 'cliente_id', 'user_id', 'nfces.funcionario_id as funcionario_id', 'total', 'desconto', 'acrescimo', 'numero_serie', 'nfces.numero',
