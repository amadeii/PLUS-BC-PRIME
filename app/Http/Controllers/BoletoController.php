        ...
        try{
            ...
            for($i=0; $i<sizeof($request->conta_id); $i++){
                ...
                $pagador = new \Eduardokum\LaravelBoleto\Pessoa([
                    ...
                    'uf' => $contaReceber->cliente->cidade ? $contaReceber->cliente->cidade->uf : '',
                    'cidade' => $contaReceber->cliente->cidade ? $contaReceber->cliente->cidade->nome : '',
            ...
            $contaBoleto->ultimo_numero = $ultimoNumero;
            $contaBoleto->save();
