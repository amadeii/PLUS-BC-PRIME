...
class FinanceiroBoletoController extends Controller
{
    ...
    public function store(Request $request){
        ...
        try{
            ...
            // seria aqui o teste de boleto
            if (optional(optional($empresa->contadorEmpresa)->contador)->wallet_id) {
                $dataBoleto["split"] = [
                    [
                        "walletId" => $empresa->contadorEmpresa->contador->wallet_id,
                        "percentualValue" => $empresa->contadorEmpresa->contador->percentual_comissao
                    ]
                ];
            }
