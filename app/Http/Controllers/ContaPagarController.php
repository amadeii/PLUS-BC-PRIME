...
class ContaPagarController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('conta-pagar.index', compact('data', 'fornecedor', 'categorias', 'temPlanoConta', 'planoSelecionado'));
    }
    ...
    public function create()
    {
        ...
        $temPlanoConta = PlanoConta::where('empresa_id', request()->empresa_id)->exists();
        return view('conta-pagar.create', compact('fornecedores', 'categorias', 'temPlanoConta'));
    }
    ...
    public function edit($id)
    {
        ...
        $temPlanoConta = PlanoConta::where('empresa_id', request()->empresa_id)->exists();
        return view('conta-pagar.edit', compact('item', 'fornecedores', 'categorias', 'temPlanoConta'));
    }
    ...
    public function pay($id)
    {
        ...
        $temPlanoConta = PlanoConta::where('empresa_id', request()->empresa_id)->exists();
        return view('conta-pagar.pay', compact('item', 'temPlanoConta'));
    }
