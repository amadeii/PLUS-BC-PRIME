...
// Indica o "papel" do tomador: 0-Remetente; 1-Expedidor; 2-Recebedor; 3-Destinatário
		...
		if($cteEmit->tomador != 4){
			...
			$doc = strtoupper(preg_replace('/[^A-Za-z0-9]/', '', $cteEmit->cpf_cnpj_tomador));
		...
		$cnpjRemente = strtoupper(preg_replace('/[^A-Za-z0-9]/', '', $cteEmit->remetente->cpf_cnpj));
		...
		$cnpjDestinatario = strtoupper(preg_replace('/[^A-Za-z0-9]/', '', $cteEmit->destinatario->cpf_cnpj));
