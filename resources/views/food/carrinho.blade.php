									...
									<tr class="sacola-alterar sacola-{{ $i->id }}" sacola-produto-id="{{ $i->produto_id }}" sacola-eid="{{ $i->id }}" sacola-pid="{{ $i->produto_id }}" valor-adicional="0" valor-somado="{{ $i->sub_total 	}}">
										...
										<td class="td-valor">
											...
											<div class="line valor">
												<span class="badge-valor">R$ {{ __moeda($i->valor_unitario) }}</span>
											</div>
										</td>

										<td class="td-valor">
											<span class="label-mobile">Sub total:</span>
											<div class="line valor">
												<span class="badge-subtotal sub_total_item">R$ {{ __moeda($i->sub_total) }}</span>
											</div>
										</td>
