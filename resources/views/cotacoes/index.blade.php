                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-label="Estado">
                                        ...
                                        <span class="badge bg-success text-white p-1">Aprovada</span>
                                        @elseif($item->estado == 'rejeitada')
                                        <span class="badge bg-danger text-white p-1">Rejeitada</span>
                                        @elseif($item->estado == 'respondida')
                                        <span class="badge bg-primary text-white p-1">Respondida</span>
                                        @else
                                        <span class="badge bg-info text-white p-1">Nova</span>
                                        @endif
                                    </td>
