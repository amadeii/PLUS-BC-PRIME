...
<div class="row">
    <div class="col-lg-4">
        ...
        <div class="card" style="height: 750px">
            ...
            <div class="card-body lista_produtos m-1" data-simplebar data-simplebar-lg style="max-height: 572px;">
    ...
    <div class="col-lg-8 produtos">
        ...
        <div class="">
                ...
                <div class="col-lg-4 col-6">
                    <div class="card widget-icon-box div-pagamento">
                        <div class="card-body">
                            ...
                            <h3 id="valor_desconto">R$ {{ __moeda($item->desconto) }}</h3>
                        </div> <!-- end card-body-->
                    </div> <!-- end card-->
                </div> <!-- end col-->
                <div class="col-lg-4 col-6">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="card div-pagamento shadow-sm" style="height:93%; border-radius:10px;">
                        <div class="card-body p-2">
                            ...
                            <div class="d-flex justify-content-between">
                                <small class="text-muted">Receber</small>
                                <strong class="text-success valor_pagar">
                                    R$ {{ __moeda(0) }}
                                </strong>
                            </div>

                            <div class="d-flex justify-content-between h-valor_restante d-none">
                                <small class="text-muted">Troco</small>
                                <strong class="text-warning valor_restante">
                                    R$ {{ __moeda(0) }}
                                </strong>
                            </div>
                    ...
                    <div class="card widget-icon-box div-pagamento" style="height: 93%">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <a class="btn btn-danger btn-sm mt-2" href="{{ route('trocas.index')}}" style="float: right;">
