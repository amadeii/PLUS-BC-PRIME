            ...
            <div class="tab-pane fade show active" id="dados" role="tabpanel">
                <div class="card">
                    <div class="row m-2 g-2">
                        ...
                        <div class="col-md-2">
                            {!!Form::text('cep', 'CEP')->attrs(['class' => 'cep'])->required(!$cadastroSimplificado)
                            !!}
                        </div>
                        
                        <div class="col-md-4">
                            {!!Form::text('rua', 'Rua')->required(!$cadastroSimplificado)
                            ->attrs(['maxlength' => '60'])
                            !!}
                        </div>
                        <div class="col-md-1">
                            {!!Form::text('numero', 'Número')->required(!$cadastroSimplificado)
                            !!}
                        </div>
                        
                        <div class="col-md-2">
                            {!!Form::text('bairro', 'Bairro')->attrs(['class' => ''])->required(!$cadastroSimplificado)
                            !!}
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            {!!Form::text('email_comercial', 'Email comercial')->attrs(['class' => ''])->type('email')
                            !!}
                        </div>

                        <div class="col-md-2">
                            {!!Form::text('nome_contato', 'Nome contato')->attrs(['class' => ''])
                            !!}
                        </div>
                        <div class="col-md-2">
                            {!!Form::tel('whatsapp_comercial', 'Whstapp comercial')->attrs(['class' => 'fone'])
                            !!}
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            type="text" 
                            class="form-control" 
                            value="{{ $item->created_at ? \Carbon\Carbon::parse($item->created_at)->format('d/m/Y H:i') : '' }}" 
                            disabled
                            >
                        </div>
                        @endif
