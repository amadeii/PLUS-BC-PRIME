<tr class="dynamic-form">
    ...
    <td width="100">
        <input style="width: 150px" value="{{ __moeda($prod->produto->valor_unitario) }}" class="form-control moeda valor_unit" type="tel" name="valor_unitario[]" id="inp-valor_unitario">
    </td>
    <td width="150">
        <input style="width: 150px" value="{{ __moeda($prod->produto->valor_unitario * $prod->quantidade) }}" class="form-control moeda sub_total" type="tel" name="sub_total[]" id="inp-subtotal">
    </td>
    <td width="80">
