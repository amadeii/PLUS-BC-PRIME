...
<div class="row">
    <div class="col-md-12">
        ...
        <input type="hidden" id="compra_selecionada" name="compra_selecionada" value="">
                                ...
                                <table class="table table-dynamic table-produtos">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="dynamic-form line_{{$key}}">
                                            ...
                                            <td>
                                                <input required style="width: 150px" value="1" class="form-control conversao" data-mask="000000.0000" type="tel" name="conversao_estoque[]">
                                            </td>
                                            <td>
            ...
            <div class="tab-pane fade show" id="fatura" role="tabpanel">
                ...
                <div class="card mt-1">
                    <div class="row m-3">
                            ...
                            <table class="table table-dynamic table-fatura" style="width: 800px">
                                ...
                                <tbody id="body-pagamento" class="datatable-body">
                                    ...
                                    <tr class="dynamic-form">
                                        ...
                                        <td width="150">
                                            <input value="{{ $f->data_vencimento }}" type="date" class="form-control vencimento" name="data_vencimento[]" id="">
                                        </td>
                                        <td width="150">
                                    ...
                                    <tr class="dynamic-form">
                                        ...
                                        <td width="150">
                                            <input value="{{ $f['vencimento'] }}" type="date" class="form-control vencimento" name="data_vencimento[]" id="">
                                        </td>
                                        <td width="150">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="button" class="btn btn-primary btn-add-tr px-2">
                                    Adicionar Pagamento
                                </button>
                            </div>
                        </div>
