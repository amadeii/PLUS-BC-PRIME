<div class="row g-2">
	...
	<span class="badge bg-success p-1">Total de produtos <strong>{{ sizeof($produtosIsert) }}</strong></span>
			...
			<table class="table table-striped mb-0">
				<thead class="table-dark">
					<tr>
						...
						<th>Valor de venda plataforma</th>
						<th>Estoque</th>
						...
						<th>NCM</th>
						<th>CEST</th>
						<th>CFOP sáida estadual</th>
						<th>CFOP sáida outro estado</th>
						...
						<th>CST/COFINS</th>
						<th>CST/IPI</th>
						<th>Código de enquandramento de IPI</th>
					</tr>
				</thead>
				<tbody>
