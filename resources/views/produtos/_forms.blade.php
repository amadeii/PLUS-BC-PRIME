        ...
        <div class="tab-pane" id="tab-identificacao">
            <div class="row g-2 m-2">
                ...
                <div class="col-md-2">
                    ...
                    <div class="input-group input-group-merge" style="margin-top: -5px">
                ...
                <div class="col-md-2">
                    {!!Form::text('codigo_interno', 'Código Interno')
                    !!}
                </div>
                ...
                @else
                @if($item->variacao_modelo_id == null)
                <div class="col-md-2">
                    {!!Form::tel('estoque_atual', 'Estoque atual')
                    ->attrs((isset($item) && (!$item->unidadeDecimal())) ? ['data-mask' => '000000'] : ['class' => 'qtd'])
                    ->value(isset($item) && $item->estoque ? ((!$item->unidadeDecimal()) ? number_format($item->estoque->quantidade, 0) : number_format($item->estoque->quantidade, __casas_decimais_quantidade(), ',', '')) : '')
                    !!}
                </div>
                @endif
                @endif
                ...
                <div class="col-md-2">
                    {!!Form::select('materia_prima', 'Materia prima', ['0' => 'Não', '1' => 'Sim'])
                    ->attrs(['class' => 'form-select'])
                    !!}
                </div>
                ...
                <div class="col-12 div-combo">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            {!!Form::select('lancar_produtos_combo', 'Lançar itens do combo', [0 => 'Não', 1 => 'Sim'])
                            ->attrs(['class' => 'form-select'])
                            !!}
                        </div>
                    </div>
                ...
                <div class="col-md-2 mt-3">
                    ...
                    <div class="card shadow-sm border-0 p-3 text-center">
                        ...
                        <label class="fw-semibold mb-2">
                            <i class="ri-image-line text-primary"></i> Imagem do produto
                        </label>

                        <div class="logo-upload position-relative">
                            ...
                            <button type="button" id="btn-remove-imagem" class="btn-remove-logo">
                        ...
                        @isset($item)
                        <a href="{{ route('produtos.remove-image', [$item->id])}}" class="text-danger small mt-2">
                                ...
                                <div class="row">
                                   ...
                                   <!--  <div class="col-md-2">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        ->attrs(['class' => 'numero-virgula', 'maxLength' => 10])
                                        !!}
                                    </div>
                                    <div class="col-md-3">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>
                                    ...
                                    <div class="form-check form-switch form-checkbox-danger">
                                        <input type="checkbox" name="veiculo_produto" class="form-check-input" id="inp-veiculo_produto" @isset($item) @if($item->tpOp != null) checked @endif @endif><strong>Veículo</strong>
                                    </div>
                                </h5>
                            </div>

                            <div class="card-body div-veiculo_produto d-none m-card" style="margin-top: -40px">

                                <div class="row">

                                    <div class="col-md-2">
                                        {!!Form::select('tag_veiculo_fiscal', 'Gerar Tag NFe', [0 => 'Não', 1 => 'Sim'])
                                        ->attrs(['class' => 'form-select'])
                                        !!}
                                    </div>

                                    <div class="col-md-2">
                                        {!!Form::select('tpOp', 'Tipo da operação', ['' => 'Selecione'] + App\Models\Veiculo::tiposOperacao())
                                        ->attrs(['class' => 'form-select'])
                                        !!}
                                    </div>

                                    <div class="col-md-3">
                                        {!!Form::text('chassi', 'Chassi')!!}
                                    </div>

                                    <div class="col-md-2">
                                        {!!Form::tel('cCor', 'Código Cor')!!}
                                    </div>

                                    <div class="col-md-3">
                                        {!!Form::text('xCor', 'Descrição Cor')!!}
                                    </div>

                                    <div class="col-md-2">
                                        {!!Form::tel('pot', 'Potência')!!}
                                    </div>

                                    <div class="col-md-2">
                                        {!!Form::tel('cilin', 'Cilindradas')!!}
                                    </div>

                                    <div class="col-md-2">
                                        {!!Form::tel('pesoL', 'Peso Líquido')!!}
                                    </div>

                                    <div class="col-md-2">
                                        {!!Form::tel('pesoB', 'Peso Bruto')!!}
                                    </div>

                                    <div class="col-md-3">
                                        {!!Form::text('nSerie', 'Número Série')!!}
                                    </div>

                                    <div class="col-md-2">

                                        {!!Form::select('tpComb', 'Tipo Combustível', ['' => 'Selecione'] + App\Models\Veiculo::tiposCompustivel())
                                        ->attrs(['class' => 'form-select'])
                                        !!}
                                    </div>

                                    <div class="col-md-3">
                                        {!!Form::text('nMotor', 'Número Motor')!!}
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        {!!Form::tel('dist', 'Distância Eixos')!!}
                                    </div>

                                    <div class="col-md-2">
                                        {!!Form::tel('anoMod', 'Ano Modelo')!!}
                                    </div>

                                    <div class="col-md-2">
                                        {!!Form::tel('anoFab', 'Ano Fabricação')!!}
                                    </div>

                                    <div class="col-md-2">

                                        {!!Form::select('tpPint', 'Tipo Pintura', ['' => 'Selecione'] + App\Models\Veiculo::tiposPintura())
                                        ->attrs(['class' => 'form-select'])
                                        !!}
                                    </div>

                                    <div class="col-md-2">
                                        {!!Form::select('tpVeic', 'Tipo Veículo', ['' => 'Selecione'] + App\Models\Veiculo::tipos())
                                        ->attrs(['class' => 'form-select'])
                                        !!}
                                    ...
                                    <div class="col-md-2">
                                        {!!Form::select('espVeic', 'Espécie', ['' => 'Selecione'] + App\Models\Veiculo::especies())
                                        ->attrs(['class' => 'form-select'])
                                        !!}
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        {!!Form::select('VIN', 'Condição do VIN', ['R' => 'Remarcado', 'N' => 'Normal'])
                                        ->attrs(['class' => 'form-select'])
                                        !!}
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        {!!Form::select('condVeic', 'Condição do Veículo', ['1' => 'Acabado', '2' => 'Inacabado', '3' => 'Semiacabado'])
                                        ->attrs(['class' => 'form-select'])
                                        !!}
                                    </div>

                                    <div class="col-md-2">
                                        {!!Form::tel('cMod', 'Código Modelo')!!}
                                    </div>

                                    <div class="col-md-2">

                                     {!!Form::select('cCorDENATRAN', 'Cor DENATRAN', ['' => 'Selecione'] + App\Models\Veiculo::cores())
                                     ->attrs(['class' => 'form-select'])
                                     !!}
                                 </div>

                                 <div class="col-md-2">
                                    {!!Form::tel('lota', 'Lotação')!!}
                                </div>

                                <div class="col-md-2">
                                    {!!Form::select('tpRest', 'Tipo Restrição', ['' => 'Selecione'] + App\Models\Veiculo::restricoes())
                                    ->attrs(['class' => 'form-select'])
                                    !!}
                                </div>
