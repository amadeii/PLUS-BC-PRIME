...
<div class="text-center mb-3">
                    <span style="background: #4254BA;color: #fff;padding: 6px 18px;border-radius: 10px;font-weight: 700;letter-spacing: 1px;font-size: 14px;">
                        MESAS/COMANDAS
                    </span>
                </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body scroll-box">
                ...
                <h6 class="titulo-categorias">Categorias</h6>

                <div class="row">
                    <div class="col-md-12 categorias">
                        <div class="categorias-scroll">
                            <button type="button" class="list-categoria active" data-id="0">Todos</button>
                            @foreach($categorias as $c)
                            <button type="button" class="list-categoria categoria-{{$c->id}}" data-id="{{$c->id}}">
                                {{ $c->nome }}
                            </button>
                            @endforeach
                        </div>
    ...
    <div class="col-xl-3">
        <div class="card">
            <div class="card-body scroll-box">
                <div class="text-center mb-3">
                    <div style="display:inline-block; padding:8px 12px; border-radius:8px; background:#f8f9fc; box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                        <div style="font-size:13px; color:#6c757d; letter-spacing:1px;">
                            PRODUTOS DA MESA / COMANDA
                        </div>

                        @if($numeroComanda)
                        <div style="font-size:20px; font-weight:bold; color:#4e73df;">
                            #{{ $numeroComanda }}
                        </div>
                        @endif
                    </div>
