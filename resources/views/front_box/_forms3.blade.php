    ...
    <div class="row">
        ...
        <div class="col-lg-7">
            ...
            <div class="row produtos-lateral">
                @foreach($produtos as $p)
                @if($p->validaEstoque())
                <div class="col-6 col-lg-3 col-sm-3 col-xl-2 col-md-4 prod p-2 card-prod-{{ $p->id }}" onclick="adicionarItemCard('{{ $p->id }}')">
                    <div class="card produto-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="produto-codigos">
                                @if(strlen($p->referencia) > 0)
                                <span class="ref">REF:{{ $p->referencia }}</span>
                                @endif

                                @if(strlen($p->referencia_balanca) > 0)
                                <span class="bal">BAL:{{ $p->referencia_balanca }}</span>
                                @endif
                            </div>
            ...
            <div class="row btns pdv-actions-footer">
                <div class="col-12 col-lg-6 col-xl-3 col-sm-6 p-1">
                    <button type="button" class="pdv-action-btn danger" onclick="openModalCliente()">
                ...
                <div class="col-12 col-lg-6 col-xl-3 col-sm-6 p-1">
                    <button type="button" class="pdv-action-btn primary" onclick="openModalVendedor()">
                ...
                <div class="col-12 col-lg-6 col-xl-3 col-sm-6 p-1">
                    <button type="button" id="btnPagamentoMulti" class="pdv-action-btn dark" onclick="openModalMultiploPagamento()">
                        <i class="ri-price-tag-3-line"></i>
                        <span>Múltiplo pagamento</span>
                        <small>[F7]</small>
                    </button>
                </div>

                <div class="col-12 col-lg-6 col-xl-3 col-sm-6 p-1">
                    <button type="button" class="pdv-action-btn warning" onclick="openModalListaPreco()">
                        <i class="ri-file-list-line"></i>
                        <span>Lista de preços</span>
                    </button>
                </div>

                <div class="col-12 col-xl-3 col-lg-6 p-1">
                    <button type="button" id="btnDinheiro" class="pdv-action-btn success" onclick="openModalDinheiro()">
                ...
                <div class="col-12 col-xl-3 col-lg-6 p-1">
                    <button type="button" id="btnCartaoCredito" class="pdv-action-btn slate" onclick="openModalCartao('03')">
                ...
                <div class="col-12 col-xl-3 col-lg-6 p-1">
                    <button type="button" id="btnCartaoDebito" class="pdv-action-btn danger" onclick="openModalCartao('04')">
                ...
                <div class="col-12 col-xl-3 col-lg-6 p-1" onclick="setPagamento('17')">
                    <button type="button" id="btnPix" class="pdv-action-btn primary">
