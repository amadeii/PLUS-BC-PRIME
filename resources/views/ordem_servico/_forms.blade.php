<div class="row g-2">
    ...
    <div class="col-md-3">
        {!!Form::select('funcionario_id', 'Funcionário', ['' => 'Selecione'] + $funcionarios->pluck('nome', 'id')->all())->attrs(['class' => 'form-select'])->required(__isSegmentoPlanoOtica())->id('func')
        !!}
    </div>
    <div class="col-md-3">
        {!!Form::select('tecnico_id', 'Técnico', ['' => 'Selecione'] + $funcionarios->pluck('nome', 'id')->all())->attrs(['class' => 'form-select'])->required(__isSegmentoPlanoOtica())
        !!}
    </div>
