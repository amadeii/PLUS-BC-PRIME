            ...
            <div class="card-body">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row mt-3 g-2">
                        ...
                        @if(!__isSegmentoPlanoOtica() && ($configGeral && $configGeral->tipo_ordem_servico == 'oficina'))
                        <div class="col-md-2">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Envio de Ordem de Serviço WhatsApp</h5>
            ...
            <div class="modal-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        {!!Form::checkbox('enviar_pedido_a4', 'Enviar Impressão A4')
                        ->value(1)
                        !!}
                    </div>
                    <br>
...
<script type="text/javascript">
    ...
    function enviarWpp(id, tipo){
        ...
        OSID = id
        TIPO = tipo
        $.get(path_url + "api/envio-fatura-wpp", {id: id, tipo: 'os'})
        .done((data) => {
            console.log(data)
    ...
    $('.btn-enviar-wpp').click(() => {
        ...
        $.post(path_url + "api/envio-fatura-wpp/create-files-ordem-servico", data)
        .done((data) => {
