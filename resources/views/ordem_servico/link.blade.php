				...
				<div class="mt-2 p-3 bg-light border rounded">
					<div class="row">
						<div class="col-md-4 col-12">
							<strong>Total produtos:</strong><br>
							R$ {{ __moeda($totalProdutos) }}
						</div>

						<div class="col-md-4 col-12">
							<strong>Desconto produtos:</strong><br>
							{{ __moeda($percentualDescontoProdutos) }}% 
							<span class="text-danger">(- R$ {{ __moeda($valorDescontoProdutos) }})</span>
						</div>

						<div class="col-md-4 col-12">
							<strong>Total produtos com desconto:</strong><br>
							<span class="valor">R$ {{ __moeda($totalProdutosComDesconto) }}</span>
						</div>
					</div>
				</div>
				@endif
