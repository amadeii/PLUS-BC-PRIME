        ...
        <div class="alert alert-warning border-0 d-flex align-items-start mx-3 mb-4">
            ...
            <div>
                ...
                <small>
                    ...
                    <strong>Cancelado</strong> não significa que a NFC-e foi cancelada na SEFAZ.
                    Para cancelamento fiscal válido é necessário utilizar o processo oficial de cancelamento da NFC-e.
                </small>
            </div>
        </div>
        <hr>
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                        ...
                        <div>
                            ...
                            <div class="fw-bold fs-5">
                                {{ $item->cliente ? $item->cliente->razao_social : 'Consumidor Final' }}
                            </div>
                        </div>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-3">
                            <div class="bg-light rounded-3 p-2 h-100">
                                ...
                                <div class="fw-semibold small">
                                    {{ $item->cliente && $item->cliente->cidade ? $item->cliente->cidade->nome . ' (' . $item->cliente->cidade->uf . ')' : '--' }}
                                </div>
                            </div>
                        </div>
