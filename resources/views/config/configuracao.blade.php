                                ...
                                <div class="col-md-2 mt-3">
                                    ...
                                    <div class="card shadow-sm border-0 p-3 text-center">
                                        ...
                                        <label class="fw-semibold mb-2">
                                            <i class="ri-image-line text-primary"></i> Logo do Sistema
                                        </label>
                                        ...
                                        @isset($item)
                                        <a href="{{ route('config.delete-logo') }}" class="text-danger small mt-2">
                            ...
                            <div class="row m-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button type="button" class="btn btn-dark" id="btn_token"><a class="ri-refresh-line text-white"></a></button>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="card shadow-sm border-0 m-2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('config.delete-certificado') }}" class="btn btn-sm btn-danger">
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="fw-bold">{{ $dadosCertificado['serial'] }}</div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="fw-bold text-success">
                                                    ...
                                                    {{ __data_pt($dadosCertificado['inicio']) }}
                                                </div>
                                            </div>

                                            <div class="col-md-3">
                                                <small class="text-muted">Expiração</small>
                                                <div class="fw-bold text-danger">
                                                    <i class="ri-calendar-close-line"></i>
                                                    {{ __data_pt($dadosCertificado['expiracao']) }}
                                                </div>
                                            </div>

                                            <div class="col-md-12 mt-2">
                                                <small class="text-muted">ID</small>
                                                <div class="fw-bold">{{ $dadosCertificado['id'] }}</div>
                                            </div>
                                        ...
                                        <div class="alert alert-danger mb-0">
                                            ...
                                            <strong>{{ $dadosCertificado['mensagem'] }}</strong>
                                        </div>
...
<script type="text/javascript">
    ...
    $(document).on("blur", "#inp-cpf_cnpj", function () {
        ...
        let cpf_cnpj = $(this).val().replace(/[^0-9A-Za-z]/g,'')
