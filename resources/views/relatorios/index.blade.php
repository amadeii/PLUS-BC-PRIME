    ...
    <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 mt-2">
                                ...
                                ->attrs(['class' => 'form-select plano_conta'])
                                ->id('plano_conta')
                                !!}
                            </div>
                            @endif
                            ...
                            <div class="col-md-6 col-12 mt-2">
                                {!!Form::select('categoria_id', 'Categoria', ['' => 'Selecione'] + $categoriasContaPagar->pluck('nome', 'id')->all())
                                ->attrs(['class' => 'form-select select2'])
                                !!}
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 mt-2">
                                {!!Form::select('categoria_id', 'Categoria', ['' => 'Selecione'] + $categoriasContaReceber->pluck('nome', 'id')->all())
                                ->attrs(['class' => 'form-select select2'])
                                !!}
                            </div>
        ...
        <div class="col-12 col-md-6">
            <form method="get" action="{{ route('relatorios.movimentacao') }}" target="_blank">
                <div class="card">
                    <div class="card-header">
                        <h5>Relatório de Movimentação de Vendas</h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-2">
                            <div class="col-md-3 col-12">
        ...
        <div class="col-12 col-md-6">
            <form method="get" action="{{ route('relatorios.movimentacoes') }}" target="_blank">
                <div class="card">
                    <div class="card-header">
                        <h5>Registro de Movimentações</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 col-12">
                            ...
                            <div class="col-md-4 col-12">
                                {!!Form::select('usuario_id', 'Usuário', ['' => 'Selecione'] + $usuarios->pluck('name', 'id')->all())
                                ->attrs(['class' => 'form-select'])->required()
                                ->id('user')
                                !!}
                            </div>
