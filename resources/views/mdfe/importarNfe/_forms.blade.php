<div class="row g-2">
    ...
    <div class="col-md-2">
        ...
        )->attrs(['class' => 'select2 class-required'])->required()->value(2) !!}
    </div>
    <div class="col-md-2">
        {!! Form::select(
        'tp_transp',
        ...
        )->attrs(['class' => 'select2'])->required()->value(2) !!}
    </div>
    <div class="col-md-2">
    ...
    <div class="col-md-3">
        ...
        )->attrs(['class' => 'select2 class-required',])->required()->value($nfe->veiculo_id) !!}
    </div>
    <div class="col-md-3">
        {!! Form::select(
        'veiculo_reboque_id',
    ...
    <div class="row card-body g-3 m-1">
        ...
        <div class="col-md-3">
            {!! Form::text('produto_pred_nome', 'Nome')->attrs(['class' => ''])->value($nfe->produto_predominante) !!}
        </div>
        <div class="col-md-2">
            {!! Form::tel('produto_pred_ncm', 'NCM')->attrs(['class' => 'ncm'])->value($nfe->produto_ncm) !!}
        </div>
        <div class="col-md-2">
            {!! Form::tel('produto_pred_cod_barras', 'Código de barras')->attrs(['class' => ''])->value($nfe->produto_codigo_barras) !!}
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            {!! Form::tel('cep_descarrega', 'Cep descarrega')->attrs(['class' => 'cep'])->value($nfe->cep_descarrega) !!}
        </div>
        <div class="col-md-2">
        ...
        <div class="card">
            <div class="row m-3">
                ...
                <div class="col-md-3 mt-3">
                    ...
                    <select class="form-select motorista_select" name="motorista_id">
                        <option value="">Selecione</option>
                        @foreach($motoristas as $m)
                        <option @if($m->padrao) selected @endif data-nome="{{ $m->nome }}" data-cpf="{{ $m->cpf }}" value="{{ $m->id }}">
                            {{ $m->nome }}
                        </option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="row m-3">
                        ...
                        @isset($gruposPagamento)
                        <div class="col-md-2">
                            {!! Form::select('grupo_pagamento_id', 'Selecione o grupo', ['' => 'Selecione'] + $gruposPagamento->pluck('nome_pagador', 'id')->all())
        ...
        <div class="form-descarregamento">
            <div class="card">
                <div class="row m-3">
                    ...
                    <div class="col-md-2 mt-3">
                        {!! Form::tel('quantidade_rateio', 'Quantidade de rateio (transporte)')->attrs(['data-mask' => '000,00', 'class' => 'ignore'])->value(0)!!}
                    </div>
                    <div class="col-md-2 mt-3">
                        {!! Form::text('id_unidade_carga', 'ID unidade da carga')->value(0) !!}
                    </div>
                    <div class="col-md-2 mt-3">
            ...
            <div class="card">
                <div class="row m-3">
                    ...
                    <div class="col-md-3 mt-3">
                        <br>
                        <button type="button" class="btn btn-info btn_info_desc">
                            Adicionar informações do descarregamento
                        </button>
                    </div>
                </div>
            </div>
                ...
                <table class="table mb-0 table-striped table-descarregamento">
                    ...
                    <tbody class="" id="">
                        ...
                        <tr>
                            ...
                            <td>
                                <input style="width: 150px" readonly type="tel" name="quantidade_rateio_row[]" class="form-control" value="{{ $i['quantidade'] ? number_format($i['quantidade'], 2) : 0 }}">
                            </td>
                            <td>
                                <input style="width: 150px" readonly type="tel" name="quantidade_rateio_carga_row[]" class="form-control" value="0">
                            </td>
                            <td>
                            ...
                            <td>
                                <input style="width: 150px" readonly type="tel" name="lacres_transporte_row[]" class="form-control" value='["00"]'>
                            </td>
                            <td>
                                <input style="width: 150px" readonly type="tel" name="lacres_unidade_row[]" class="form-control" value='["00"]'>
                            </td>
                            <td>
