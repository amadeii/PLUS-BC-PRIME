        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row g-2">
                    ...
                    <div class="col-md-3">
                        {!! Form::tel('quantidade_rateio_modal', 'Quantidade de rateio (transporte)')->attrs(['data-mask' => '000,00', 'data-mask-reverse' => 'true']) !!}
                    </div>
                    
                    <div class="col-md-3">
                        {!! Form::tel('quantidade_rateio_carga_modal', 'Quantidade de rateio (unidade carga)')->attrs(['data-mask' => '000,00', 'data-mask-reverse' => 'true', 'class' => 'ignore']) !!}
                    </div>
