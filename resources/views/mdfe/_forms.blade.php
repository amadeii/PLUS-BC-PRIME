<div class="row g-2">
    ...
    <div class="col-md-2">
        {!! Form::tel('cnpj_contratante', 'CNPJ do contratante')->attrs(['class' => 'cnpj'])->required() !!}
    </div>
    <div class="col-md-2">
    ...
    <div class="col-md-2">
        ...
        'cUnid',
        'Unidade de medida',
        ['' => 'Selecione...'] + \App\Models\Mdfe::unidadesCargaMdfe(),
        )->attrs(['class' => 'form-select'])->required() !!}
    </div>
    <div class="col-md-2">
        ...
        <div class="form-descarregamento">
            <div class="card">
                <div class="row m-3">
                    ...
                    <div class="col-md-2 mt-3">
                        {!! Form::text('id_unidade_carga', 'ID unidade da carga')->attrs(['class' => 'ignore']) !!}
                    </div>
                    <div class="col-md-3 mt-3">
