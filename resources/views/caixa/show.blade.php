                ...
                <div class="row">
                    ...
                    <div class="row g-1">
                        ...
                        function iconeFormaPagamento($nome) {
                            ...
                            if (str_contains($nome, 'dinheiro')) return 'ri-cash-fill text-success';
                            if (str_contains($nome, 'cheque')) return 'ri-file-list-3-line text-info';
                            if (str_contains($nome, 'pix')) return 'ri-qr-code-line text-primary';
                            if (str_contains($nome, 'crédito')) return 'ri-bank-card-fill text-warning';
                            if (str_contains($nome, 'débito')) return 'ri-bank-card-line text-primary';

                            return 'ri-coins-line text-muted';
                        }
                        @endphp

                        @if(isset($item->formasPagamento) && $item->formasPagamento->count() > 0)

                        @foreach($item->formasPagamento as $forma)
                        <div class="col-6 col-md-2">
                            <div class="info-card">
                                <div class="info-icon">
                                    <i class="{{ iconeFormaPagamento($forma->nome) }}"></i>
                                </div>
                                <div class="info-title">{{ $forma->nome }}</div>
                                <div class="info-value">{{ __moeda($forma->valor) }}</div>
                            </div>
                        </div>
                        @endforeach
                        ...
                        @if((float)$item->valor_dinheiro > 0)
                        <div class="col-6 col-md-2">
                            <div class="info-card">
                                <div class="info-icon">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <div style="background: #F1F5F9;border-left: 4px solid #3B82F6;padding: 8px 12px;border-radius: 6px;font-size: 13px;color: #334155;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($i->troco > 0)
                                        <span class="badge bg-danger p-1 mt-1">Troco R$ {{ __moeda($i->troco) }}</span> 
                                        @endif

                                        @if($i->tefLog)
                                        <span class="badge bg-primary p-1 mt-1">TEF</span> 
                                        @endif
                                    </td>
                        ...
                        <table class="table devol-table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @php 
                                    $diferenca = $t->valor_troca - $t->valor_original;
                                    @endphp

                                    <td style="color: {{ $diferenca < 0 ? '#DC2626' : '#16A34A' }}!important; font-weight: bold;">
                                        {{ __moeda($diferenca) }}
                                    </td>
                                </tr>
                                @empty
