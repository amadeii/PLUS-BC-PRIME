    ...
    <div class="row">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="card mt-3 mov-card-os">

                    <div class="card-header mov-os-header">
                        <i class="ri-shopping-bag-2-fill"></i> Movimentações de Ordens de Serviço
                    </div>
                    ...
                    <div class="card-body mov-body p-0">
                        ...
                        <table class="table mov-table mb-0">
                            ...
                            <tbody>
                                @forelse ($ordens as $i)
                                <tr>
                                    <td>{{ $i->codigo_sequencial }}</td>
                                    <td>{{ $i->cliente ? $i->cliente->razao_social : 'NÃO IDENTIFICADO' }}</td>
                                    <td>{{ __data_pt($i->created_at) }}</td>

                                    <td class="text-success fw-bold">R$ {{ __moeda($i->valor) }}</td>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="demo-box">
                                    ...
                                    <div class="demo-row">
                                        Ordens de Serviço
                                        <span class="demo-value green">R$ {{ __moeda($somaOs) }}</span>
                                    </div>
                                    ...
                                    <div class="demo-total">
                                        Total de Entradas
                                        @php $totalEntradas = $trocasPagasPorCliente + $somaSuprimentos + $item->valor_abertura + $somaVendas + $somaContasReceber + $somaOs; @endphp
                            ...
                            <div class="col-md-4">
                                <div class="demo-box">
                                    ...
                                    <div class="demo-row" style="height: 90px;">
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="demo-box">
                                    ...
                                    <div class="demo-row" style="height: 93px;">
                                    </div>
