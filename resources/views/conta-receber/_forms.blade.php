...
<div class="row g-2">
    ...
    <div class="col-md-12 mb-3">
        <div class="alert alert-warning d-flex align-items-center" role="alert" style="border-left: 5px solid #FFC070;">
            <i class="ri-information-line" style="font-size: 20px; margin-right: 10px;"></i>
            <div>
                O valor recebido é inferior ao valor da conta.
                Gere uma nova conta a receber com o saldo restante ou finalize a baixa abaixo.
            </div>
        </div>
        <a href="{{ route('conta-receber.index') }}" class="btn btn-dark btn-sm px-3">
            <i class="ri-arrow-left-double-fill"></i>Finalizar assim mesmo
        </a>
    </div>
    @endif
    ...
    <input type="hidden" value="{{ isset($item) && $item->conta_receber_origem_id ? $item->conta_receber_origem_id : request()->id }}" name="conta_receber_origem_id">
    @endif
