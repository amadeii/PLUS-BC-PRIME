    ...
    <div class="card-body">
        ...
        <div class="pl-lg-4">
            <div class="row g-2">
                ...
                <div class="col-md-2">
                    {!!Form::text('', 'Valor Recebido')->value(__moeda($item->valor_recebido))->disabled()
                    !!}
                </div>
                <div class="col-md-2">
                    {!!Form::text('', 'Valor Multa')->value(__moeda($item->valor_multa))->disabled()
                    !!}
                </div>
                <div class="col-md-2">
                    {!!Form::text('', 'Valor Juros')->value(__moeda($item->valor_juros))->disabled()
                    !!}
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-4">
                    {!!Form::text('', 'Plano de conta')->disabled()->value($item->planoConta->descricao)
                    !!}
                </div>
                @endif
