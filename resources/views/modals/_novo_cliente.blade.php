            ...
            <div class="modal-body">
                <div class="row g-2">
                    <div class="col-md-3">
                        ...
                        ->attrs(['class' => 'cpf_cnpj !(isset($cadastroSimplificado) && $cadastroSimplificado) ? ignore : "" '])
                        ->required(!(isset($cadastroSimplificado) && $cadastroSimplificado))
                        !!}
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                        {!!Form::select('novo_consumidor_final', 'Consumidor Final', [0 => 'Não', 1 => 'Sim'])->attrs(['class' => 'form-select'])
                        !!}
                    </div>
                    <div class="col-md-2">
                        {!!Form::select('novo_status', 'Ativo', [ 1 => 'Sim', 0 => 'Não'])->attrs(['class' => 'form-select'])
                        !!}
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        ->attrs([
                        'class' => 'select2 ' . (!empty($cadastroSimplificado) ? 'ignore' : '')
                        ])
                        ->required(!(isset($cadastroSimplificado) && $cadastroSimplificado))
                        !!}
                    </div>
                    <div class="col-md-3">
                        {!!Form::text('novo_rua', 'Rua')->attrs(['class' => (!empty($cadastroSimplificado) ? 'ignore' : '') ])
                        ->required(!(isset($cadastroSimplificado) && $cadastroSimplificado))
                        !!}
                    </div>
                    <div class="col-md-2">
                        {!!Form::text('novo_numero', 'Número')->attrs(['class' => (!empty($cadastroSimplificado) ? 'ignore' : '') ])
                        ->required(!(isset($cadastroSimplificado) && $cadastroSimplificado))
                        !!}
                    </div>
                    <div class="col-md-3">
                        {!!Form::text('novo_cep', 'CEP')->attrs(['class' => 'cep '. (!empty($cadastroSimplificado) ? 'ignore' : '') ])
                        ->required(!(isset($cadastroSimplificado) && $cadastroSimplificado))
                        !!}
                    </div>
                    <div class="col-md-3">
                        {!!Form::text('novo_bairro', 'Bairro')->attrs(['class' => (!empty($cadastroSimplificado) ? 'ignore' : '')])
                        ->required(!(isset($cadastroSimplificado) && $cadastroSimplificado))
                        !!}
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                        {!!Form::date('novo_data_nascimento', 'Data de nascimento')
                        ->attrs(['class' => 'ignore'])
                        !!}
                    </div>
                </div>
