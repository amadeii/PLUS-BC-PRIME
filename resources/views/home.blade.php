    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row g-3 align-items-stretch" style="margin-top: -30px;">
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <div class="row">
                            @if(in_array('Mostrar dados de caixa', $homeComponentes) || $configGeral == null)
            ...
            <div class="row p-2 g-">
                ...
                <div class="col-12 col-lg-3 col-xl-2">
                    <div class="card widget-icon-box text-bg-primary">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="text-">NFe APROVADAS</h4>
                                <h3 class="total-nfe-aprovadas">0</h3>
                                <span class="span-box total-nfe-aprovadas-valor">R$ 0,00</span>
                            </div>
                            <div class="avatar-sm">
                                <span class="avatar-title shadow">
                ...
                <div class="col-12 col-lg-3 col-xl-2">
                    <div class="card widget-icon-box text-bg-info">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="text-">NFCe APROVADAS</h4>
                                <h3 class="total-nfce-aprovadas">0</h3>
                                <span class="span-box total-nfce-aprovadas-valor">R$ 0,00</span>
                            </div>
                            <div class="avatar-sm">
                                <span class="avatar-title shadow">
...
<script type="text/javascript">
    ...
    function dadosCards(){
        ...
        .done((success) => {
            ...
            $('.total-nfe-aprovadas').text(success['nfe_aprovadas'])
            $('.total-nfe-aprovadas-valor').text("R$ " + convertFloatToMoeda(success['nfe_aprovadas_valor']))

            $('.total-nfce-aprovadas').text(success['nfce_aprovadas'])
            $('.total-nfce-aprovadas-valor').text("R$ " + convertFloatToMoeda(success['nfce_aprovadas_valor']))
        })
        .fail((err) => {
            console.log(err)
        })
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        borderWidth: 3,
                        borderColor: '#8448dc',
                        backgroundColor: 'rgba(132,72,220,0.12)',
                        fill: true,
                        tension: 0.4,
                        pointRadius: 4,
                        pointHoverRadius: 6
