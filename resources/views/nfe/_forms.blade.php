@section('css')
<link rel="stylesheet" type="text/css" href="/css/nfe_form.css">
@endsection
                ...
                <div class="card">
                    ...
                    <div class="row m-3">
                        ...
                        <div class="row d-cliente">
                            ...
                            <div class="col-md-2">
                                {!!Form::tel('cliente_cpf_cnpj', 'CPF/CNPJ')->attrs(['class' => 'cpf_cnpj'])->required(!(isset($cadastroSimplificado) && $cadastroSimplificado))
                            ...
                            <div class="col-md-2 mt-3">
                                {!!Form::select('consumidor_final', 'Consumidor Final', [0 => 'Não', 1 => 'Sim'])->attrs(['class' => 'form-select'])->required(!(isset($cadastroSimplificado) && $cadastroSimplificado))
                            ...
                            <div class="col-md-2 mt-3">
                                {!!Form::text('cep', 'CEP')->attrs(['class' => 'cep'])->required(!(isset($cadastroSimplificado) && $cadastroSimplificado))
                                ->value(isset($item) ? $item->cliente->cep : '')
                                !!}
                            </div>
                            <div class="col-md-3 mt-3">
                                <label>Cidade</label>
                                <select {{ !(isset($cadastroSimplificado) && $cadastroSimplificado) ? 'required' : '' }} class="form-control select2 cidade_id cidade" name="cliente_cidade" id="inp-cidade_cliente">
                                    <option value="">Selecione..</option>
                            ...
                            <div class="col-md-3 mt-3">
                                {!!Form::text('cliente_rua', 'Rua')->attrs(['class' => 'rua'])->required(!(isset($cadastroSimplificado) && $cadastroSimplificado))
                                ->value(isset($item) ? $item->cliente->rua : '')
                                !!}
                            </div>
                            <div class="col-md-1 mt-3">
                                {!!Form::text('cliente_numero', 'Número')->attrs(['class' => ''])->required(!(isset($cadastroSimplificado) && $cadastroSimplificado))
                                ->value(isset($item) ? $item->cliente->numero : '')
                                !!}
                            </div>
                            
                            <div class="col-md-2 mt-3">
                                {!!Form::text('cliente_bairro', 'Bairro')->attrs(['class' => 'bairro'])->required(!(isset($cadastroSimplificado) && $cadastroSimplificado))
            ...
            <div class="tab-pane fade" id="produtos" role="tabpanel">
                <div class="card">
                    <div class="row m-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-dynamic table-produtos" style="width: 2800px">
                                ...
                                <tbody>
                                    ...
                                    @elseif(isset($isOrdemProducao))
                                    @include('ordem_producao.partials.itens', ['prod' => $prod, 'cfop_estadual' => $item->cliente->cidade?->uf])
                        ...
                        <div class="mt-3 resumo-valores">
                            <div class="item-resumo">
                                <span>Total de Produtos</span>
                                <strong class="total_prod">R$ 0,00</strong>
                            </div>

                            <div class="item-resumo d-none h5-ipi">
                                <span>Total de IPI</span>
                                <strong class="total_ipi">R$ 0,00</strong>
                            </div>
                        </div>
            ...
            <div class="tab-pane fade show" id="fatura" role="tabpanel">
                <div class="card">
                    <div class="row g-2 m-2">
                        <div class="col-md-3">
                            ...
                            <select name="natureza_id" id="inp-natureza_id" class="form-select" required>
                                <option value="">Selecione</option>

                                @foreach($naturezas as $n)
                                <option value="{{ $n->id }}" data-indpres="{{ $n->indPres }}" @if(isset($item) && $item->natureza_id == $n->id) selected @endif @if(!isset($item) && isset($naturezaPadrao) && $naturezaPadrao != null && $naturezaPadrao->id == $n->id) selected @endif>
                                    {{ $n->descricao }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        @if(__isPlanoFiscal())
                        @if(isset($isOrdemServico) || isset($isPedidoEcommerce) || isset($isPedidoMercadoLivre) || isset($isReserva) || isset($isPedidoVendiZap) || isset($isOrdemProducao))
                        <div class="col-md-2 mt-3">
                        ...
                        <div class="col-md-2 mt-3">
                            {!!Form::select('estado_compra', 'Estado da compra', ['pendente' => 'Pendente', 'finalizado' => 'Finalizado'])
                            ->attrs(['class' => 'form-select'])
                            !!}
                        </div>
                        @endif
                        ...
                        <div class="col-md-3 mt-3">
                            ...
                            ->options(
                            isset($item) && $item->funcionario
                            ? [$item->funcionario->id => $item->funcionario->nome]
                            : (isset($vendedor)
                ...
                <div class="card mt-1">
                    <div class="row m-3">
                        ...
                        <div class="row resumo-financeiro mt-3">

                            <div class="col-3">
                                <div class="card-resumo">
                                    <span>Total da Fatura</span>
                                    <strong class="total_fatura">R$ 0,00</strong>
                                </div>
                            </div>
                            ...
                            <div class="col-3">
                                <div class="card-resumo">
                                    ...
                                    <strong class="total_frete">R$ 0,00</strong>
                                </div>
                            </div>
                            ...
                            <div class="col-3">
                                <div class="card-resumo destaque">
                                    ...
                                    <strong class="total_nfe">R$ 0,00</strong>
                                </div>
                            </div>
