                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Estado">
                                            @if($item->status)
                                            <span class="badge bg-success position-relative p-1">
                                                <i class="ri-checkbox-line"></i> Pago
                                            </span>
                                            @else
                                            @if(strtotime($item->data_vencimento) < strtotime(date('Y-m-d')))
                                            <span class="badge bg-danger position-relative p-1">
                                                <i class="ri-alert-line"></i> Em atraso
                                            </span>
                                            @else
                                            <span class="badge bg-warning position-relative p-1" >
                                        ...
                                        @endif
                                        <td>
                                            <form action="{{ route('conta-pagar.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" style="width: 250px; {{ $item->desativado == 1 ? 'opacity: 0.4; pointer-events: none;' : '' }}">
                                                @if(!$item->status)
                                                @method('delete')
