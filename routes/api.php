...
Route::group(['prefix' => 'nfe_painel'], function () {
    ...
    Route::post('/gerar-nfe-pdv', 'NFePainelController@gerarNfePdv');
});

Route::post('/faturamento-nfe-processar-lote', 'FaturamentoNfeController@processarLote');
Route::post('/faturamento-nfce-processar-lote', 'FaturamentoNfceController@processarLote');
...
Route::group(['prefix' => 'nfce_painel'], function () {
    ...
    Route::get('/cupom-fiscal/{id}', 'NFCePainelController@cupomFiscal');
});
...
Route::post('/score-diario', 'ClienteScoreController@scoreDiario');
...
Route::group(['prefix' => 'caixa'], function () {
    Route::get('/verificar-aberto', 'CaixaController@verificarAberto');
    Route::post('/abrir', 'CaixaController@abrir');

    Route::get('/saldo-dinheiro/{caixa}', 'CaixaController@saldoDinheiro');
    Route::post('/sangria', 'CaixaController@sangria');
    Route::post('/suprimento', 'CaixaController@suprimento');

    Route::get('/ver/{caixa}', 'CaixaController@verCaixa');
    Route::post('/fechar', 'CaixaController@fechar');
...
Route::group(['prefix' => 'compras'], function () {
    Route::get('/buscar-pendentes-fornecedor', 'CompraController@buscarPendentesFornecedor');
    Route::post('/comparar-compra', 'CompraController@compararCompra');
});
...
Route::post('/produtos-reajuste-update-lote', 'ProdutoController@reajusteUpdateLote')->name('produtos-reajuste.update-lote');
...
Route::group(['prefix' => 'produtos'], function () {
    ...
    Route::get('/busca-pdv', 'ProdutoController@buscaPdv');
    ...
    Route::get('/buscar-pdv4', 'ProdutoController@buscaPdv4');
    Route::get('/busca-avacada-pdv4', 'ProdutoController@buscaAvancadaPdv4');
    Route::post('/recalcular-tabela-pdv4', 'ProdutoController@recalcularTabelaPdv4');
...
Route::group(['prefix' => 'clientes'], function () {
    ...
    Route::get('/buscar-pdv4', 'ClienteController@buscarPdv4');
    Route::get('/buscar-json', 'ClienteController@buscarJson');
});
...
Route::group(['prefix' => 'venda-temporaria'], function () {
    Route::post('/store', 'VendaTemporariaController@store');
    Route::post('/abandonar', 'VendaTemporariaController@abandonar');
    Route::post('/item-remove', 'VendaTemporariaController@itemRemove');
});
...
Route::group(['prefix' => 'envio-fatura-wpp'], function () {
    ...
    Route::post('/create-files-orcamento', 'EnvioFaturaWppController@createFilesOrcamento');
    Route::post('/create-files-ordem-servico', 'EnvioFaturaWppController@createFilesOrdemServico');
});
...
Route::group(['prefix' => 'conta-receber'], function () {
    ...
    Route::get('/faturas-cliente-pdv4', 'ContaReceberController@faturasDoClientePdv4');
    Route::get('/historico-recebimento/{id}', 'ContaReceberController@historicoRecebimento');
});
...
Route::group(['prefix' => 'frenteCaixa'], function () {
    ...
    Route::post('/pdv-log', 'FrontBoxController@pdvLog');
    ...
    Route::get('/venda-suspensas-pdv4', 'FrontBoxController@vendasSuspensasPdv4');
    Route::post('/suspender-venda4', 'FrontBoxController@suspenderVenda4');
    Route::post('/cancelar-venda-suspensa/{id}', 'FrontBoxController@cancelarVendaSuspensa');
    Route::get('/continuar-venda-suspensa/{id}', 'FrontBoxController@continuarVendaSuspensa');
    Route::post('/finalizar-venda4', 'FrontBoxController@finalizarVenda4');
    Route::post('/finalizar-venda-nfe4', 'FrontBoxController@finalizarVendaNfe4');

    Route::get('/opcoes-crediario', 'FrontBoxController@opcoesCrediario');
    Route::get('/fatura-cliente/{cliente}', 'FrontBoxController@faturaCliente');
});
...
Route::group(['prefix' => 'operacoes'], function () {
    Route::get('/find/{id}', 'OperacaoController@find');
});
...
Route::group(['prefix' => 'ordemProducao'], function () {
    ...
    Route::get('/roteiro-produto/{produto_id}', 'OrdemProducaoController@roteiroProduto');
    Route::get('/materiais-produto/{produto_id}', 'OrdemProducaoController@materiaisProduto');
});
...
Route::middleware(['authKotlin'])->group(function () {
    Route::group(['prefix' => 'kotlin'], function () {
        Route::get('/home', 'Kotlin\\HomeController@index');
        Route::get('/produtos', 'Kotlin\\ProdutoController@index');
        Route::get('/produtos/{id}', 'Kotlin\\ProdutoController@find');
        Route::get('/categorias-produto', 'Kotlin\\ProdutoController@categorias');
        Route::get('/clientes', 'Kotlin\\ClienteController@index');
        Route::get('/tipos-pagamento', 'Kotlin\\VendaController@tiposPagamento');

        Route::post('/salvar-venda', 'Kotlin\\VendaController@salvarVenda');
        Route::post('/salvar-suprimento', 'Kotlin\\CaixaController@salvarSuprimento');
        Route::post('/salvar-sangria', 'Kotlin\\CaixaController@salvarSangria');
        Route::post('/verificar-caixa', 'Kotlin\\CaixaController@verificarCaixa');
        Route::post('/abrir-caixa', 'Kotlin\\CaixaController@abrirCaixa');

        Route::get('/vendas-caixa', 'Kotlin\\CaixaController@vendasDoCaixa');
        Route::get('/vendas-caixa/{id}', 'Kotlin\\CaixaController@venda');

        Route::get('/comandas', 'Kotlin\\ComandaController@getComandas');
        Route::get('/comandas/{id}', 'Kotlin\\ComandaController@findComanda');
        Route::post('/comandas-abrir', 'Kotlin\\ComandaController@abrirComanda');
        Route::post('/comandas-adicionar-item', 'Kotlin\\ComandaController@adicionarItemComanda');
    });
});
...
Route::middleware(['authApp'])->group(function () {
    ...
    Route::group(['prefix' => 'app'], function () {
        ...
        Route::post('/contas-pagar-pay', 'App\\ContaPagarController@pay');
        ...
        Route::post('/verifica-plano', 'App\\FinanceiroController@verificaPlano');
        Route::post('/gerar-pix', 'App\\FinanceiroController@gerarPix');
        Route::post('/status-pix', 'App\\FinanceiroController@statusPix');
...
Route::group(['prefix' => 'pdv'], function () {
    ...
    Route::post('/padrao-tributacao', 'PDV\\ProdutoController@padraoTributacao');
    Route::post('/produtos-store', 'PDV\\ProdutoController@store');
    Route::post('/produtos-update', 'PDV\\ProdutoController@update');
    Route::get('/cidades', 'PDV\\ClienteController@cidades');

    Route::post('/clientes', 'PDV\\ClienteController@all');
    Route::post('/clientes-store', 'PDV\\ClienteController@store');
    Route::post('/clientes-update', 'PDV\\ClienteController@update');
    ...
    Route::post('/contas-receber', 'PDV\\ContaReceberController@index');
    Route::post('/contas-receber-store', 'PDV\\ContaReceberController@store');
    Route::post('/contas-receber-update', 'PDV\\ContaReceberController@update');
    Route::post('/contas-receber-destroy', 'PDV\\ContaReceberController@destroy');
    Route::post('/contas-receber-receive', 'PDV\\ContaReceberController@receive');
    Route::post('/categorias-contas-receber', 'PDV\\ContaReceberController@categorias');

    Route::post('/comandas', 'PDV\\ComandaController@comandas');
    Route::post('/abrir-comanda', 'PDV\\ComandaController@abrirComanda');
    Route::post('/comanda-detalhe', 'PDV\\ComandaController@comandaDetalhe');
    Route::post('/comanda-add-item', 'PDV\\ComandaController@comandaAddItem');
    Route::post('/comanda-update-item', 'PDV\\ComandaController@comandaUpdateItem');
    Route::post('/comanda-remove-item', 'PDV\\ComandaController@comandaRemoveItem');
    Route::post('/comanda-adicionais', 'PDV\\ComandaController@adicionais');

    Route::post('/item-pesagem-pdv', 'PDV\\ItemPesagemPdvController@index');
    Route::post('/pdv-pesagem/salvar-pedido', 'PDV\\ItemPesagemPdvController@salvarPedido');
});
