...
Route::get('/ordem-producao-link/{hash}', 'OrdemProducaoViewController@index')->name('ordem-producao.link');
...
Route::get('/imprimir-nfce-termica/{chave}', 'ImprimirNfceController@imprimirTermica')->name('nfce.termica');
...
Route::middleware(['authh', 'validaEmpresa', 'validaHorarioAcesso', 'checkPonto'])->group(function () {
    Route::get('/home', [App\Http\Controllers\HomeController::class, 'index'])->name('home');

    Route::get('/meu-ponto', 'MeuPontoController@index')->name('meu-ponto.index');
    Route::post('/meu-ponto/bater', 'MeuPontoController@baterPonto')->name('meu-ponto.bater');
    ...
    Route::middleware(['verificaMaster'])->group(function () {
        ...
        Route::resource('nbs', 'NbsController');

        Route::get('/teste-email-super', 'TesteEmailController@index')->name('teste-email.index');
        Route::post('/teste-email-super/enviar', 'TesteEmailController@enviar')->name('teste-email.enviar');

        Route::get('/superadmin/dashboard-totais', 'SuperAdminDashboardController@index')
        ->name('superadmin.dashboard-totais');
        Route::get('/superadmin/dashboard-totais/ajax', 'SuperAdminDashboardController@totais')
        ->name('superadmin.dashboard-totais.ajax');

        Route::get('/superadmin/dashboard-detalhado', 'SuperAdminDashboardController@detalhado')
        ->name('superadmin.dashboard-detalhado');

        Route::get('/superadmin/dashboard-detalhado/ajax', 'SuperAdminDashboardController@detalhadoAjax')
        ->name('superadmin.dashboard-detalhado.ajax');
        ...
        Route::resource('planos-white-label', 'PlanoWhiteLabelController');
        ...
        Route::get('/contadores-white-label/{id}', 'ContadorController@whiteLabel')->name('contadores.white-label');
        Route::post('/contadores-white-label/{id}', 'ContadorController@saveWhiteLabel')->name('contadores.white-label.save');
        ...
        Route::post('/roles/sincronizar-permissoes', 'RoleController@sincronizarPermissoes')->name('roles.sincronizar-permissoes');
...
Route::get('nfe/imprimir-divergencias/{id}', 'NfeController@imprimirDivergencias')->name('nfe.imprimir-divergencias');
...
Route::post('nfe-unificar', 'NfeController@unificar')->name('nfe.unificar');

Route::get('/dashboard-fiscal', 'DashboardFiscalController@dashboardFiscal')->name('dashboard-fiscal.index');
...
Route::get('nfce/imprimir-tef/{id}', 'NfceController@imprimirTef')->name('nfce.imprimir-tef');
...
Route::get('/nfce-duplicar/{id}', 'NfceController@duplicar')->name('nfce.duplicar');
...
Route::get('/cte-duplicar/{id}', 'CteController@duplicar')->name('cte.duplicar');
...
Route::post('/mdfe/importar-xml-encerrar', 'MdfeController@importarXmlEncerrar')
->name('mdfe.importarXmlEncerrar');

Route::get('/mdfe-importacao', 'MdfeImportacaoController@index')->name('mdfe-importacao.index');
Route::post('/mdfe-importacao', 'MdfeImportacaoController@store')->name('mdfe-importacao.store');
...
Route::get('/item-pesagem-pdv', 'ItemPesagemPdvController@index')->name('item-pesagem-pdv.index');
Route::post('/item-pesagem-pdv', 'ItemPesagemPdvController@store')->name('item-pesagem-pdv.store');
Route::delete('/item-pesagem-pdv/{id}', 'ItemPesagemPdvController@destroy')->name('item-pesagem-pdv.destroy');

Route::get('/item-pesagem-pdv', 'ItemPesagemPdvController@index')->name('item-pesagem-pdv.index');
Route::post('/item-pesagem-pdv', 'ItemPesagemPdvController@store')->name('item-pesagem-pdv.store');
Route::delete('/item-pesagem-pdv/{id}', 'ItemPesagemPdvController@destroy')->name('item-pesagem-pdv.destroy');
Route::post('/item-pesagem-pdv/comanda', 'ItemPesagemPdvController@storeComanda')->name('item-pesagem-pdv.comanda.store');
Route::delete('/item-pesagem-pdv/comanda/{id}', 'ItemPesagemPdvController@destroyComanda')->name('item-pesagem-pdv.comanda.destroy');
...
Route::get('nuvem-shop-logs-cron', 'NuvemShopConfigController@logsCron')->name('nuvem-shop.logs-cron');
...
Route::get('woocommerce-produtos-importar', 'WoocommerceProdutoController@importar')->name('woocommerce-produtos.importar');
...
Route::get('sicredi-teste', 'SicrediController@token');
...
Route::resource('programacao-producao', 'ProgramacaoProducaoController');
Route::post('programacao-producao/gerar-of','ProgramacaoProducaoController@gerarOf')->name('programacao-producao.gerar-of');
Route::get('/programacao-producao-atualizar', 'ProgramacaoProducaoController@atualizar')->name('programacao-producao.atualizar');
Route::get('programacao-producao/pdf/pedidos', 'ProgramacaoProducaoController@pdfPedidos')->name('programacao-producao.pdf-pedidos');
Route::get('programacao-producao/pdf/produtos', 'ProgramacaoProducaoController@pdfProdutos')->name('programacao-producao.pdf-produtos');
Route::get('programacao-producao/pdf/ordens', 'ProgramacaoProducaoController@pdfOrdens')->name('programacao-producao.pdf-ordens');
Route::get('programacao-producao/pdf/materiais', 'ProgramacaoProducaoController@pdfMateriais')->name('programacao-producao.pdf-materiais');

Route::resource('centro-custo', 'CentroCustoController');
Route::resource('setor', 'SetorController');
Route::resource('grupo-pagamento-padrao', 'GrupoPagamentoPadraoController');
Route::get('grupo-pagamento-padrao/get/{id}', 'GrupoPagamentoPadraoController@getById');
Route::resource('operacao', 'OperacaoController');
Route::resource('rotina-fabricacao', 'RotinaFabricacaoController');
Route::get('/rotina-fabricacao/create-form/{produto_id}', 'RotinaFabricacaoController@createForm')->name('rotina-fabricacao.create-form');

Route::get('/produtos/rotina/{id}/projecao-custo', 'ProdutoRotinaController@projecaoCusto')
->name('produtos.rotina.projecao-custo');

Route::get('/produtos/rotina/{id}/simular-custo', 'ProdutoRotinaController@simularCusto')
->name('produtos.rotina.simular-custo');

Route::get('/produtos/rotina/{id}/simulacao-pdf', 'ProdutoRotinaController@simulacaoPdf')
->name('produtos.rotina.simulacao-pdf');

Route::get('/produtos/rotina/{id}/print-instrucao', 'ProdutoRotinaController@printInstrucao')
->name('produtos.rotina.print-instrucao');
...
Route::post('contas-empresa-transferencia-store', 'ContaEmpresaController@transferenciaStore')->name('contas-empresa.transferencia-store');
...
Route::resource('sicredi-config', 'SicrediConfigController');
Route::resource('asaas-config', 'AsaasConfigController');

Route::resource('configuracao-crediario', 'ConfiguracaoCrediarioController');

Route::resource('cobrancas', 'CobrancaController');
Route::get('/cobrancas/{id}/boleto', 'CobrancaController@verBoleto')->name('cobrancas.ver-boleto');
Route::get('/cobrancas-logs', 'CobrancaController@logs')->name('cobrancas.logs');
Route::post('/cobrancas/{id}/consultar-status', 'CobrancaController@consultarStatus')->name('cobrancas.consultar-status');
Route::post('/cobrancas/{id}/baixar-titulo', 'CobrancaController@baixarTitulo')->name('cobrancas.baixar-titulo');
Route::resource('cobranca-bancaria', 'CobrancaBancariaController');
Route::get('/cobranca-bancaria-banco-dados', 'CobrancaBancariaController@bancoDados')->name('cobranca-bancaria.banco-dados');
...
Route::resource('sitef-config', 'SitefConfigController');
Route::get('sitef-get-config', 'SitefConfigController@getConfig');

Route::resource('scope-config', 'ScopeConfigController');

Route::post('tef-store-log', 'SitefController@storeLog');
Route::post('tef-store-log-scope', 'SitefController@storeLogScope');

Route::get('tef-vendas', 'SitefController@vendas');
Route::post('tef-marcar-cancelado', 'SitefController@marcarCancelado');
...
Route::middleware(['verificaEmpresa', 'validaPlano', 'validaContrato'])->group(function () {
    ...
    Route::resource('faturamento-nfe', 'FaturamentoNfeController');
    Route::post('/faturamento-nfe/faturar/{id}', 'FaturamentoNfeController@faturar')->name('faturamento-nfe.faturar');

    Route::get('/faturamento-nfe-lote', 'FaturamentoNfeController@lote')->name('faturamento-nfe.lote');
    Route::get('/faturamento-nfe-download-xml', 'FaturamentoNfeController@downloadXml')
    ->name('faturamento-nfe.download-xml');

    Route::resource('faturamento-nfce', 'FaturamentoNfceController');
    Route::get('/faturamento-nfce-download-xml', 'FaturamentoNfceController@downloadXml')
    ->name('faturamento-nfce.download-xml');
    Route::get('/faturamento-nfce-lote', 'FaturamentoNfceController@lote')->name('faturamento-nfce.lote');


    // Relatório XML contador
    Route::group(['prefix' => 'relatorio-xml-contador'], function () {
        Route::get('/', 'RelatorioXmlContadorController@index')->name('relatorio-xml-contador.index');
        Route::post('/store', 'RelatorioXmlContadorController@store')->name('relatorio-xml-contador.store');
        Route::get('/logs', 'RelatorioXmlContadorController@logs')->name('relatorio-xml-contador.logs');
        Route::post('/testar-envio', 'RelatorioXmlContadorController@testarEnvio')->name('relatorio-xml-contador.testar-envio');
    });
    ...
    Route::resource('venda-temporaria', 'VendaTemporariaController');
    Route::resource('nfce', 'NfceController');
    Route::resource('controle-acesso', 'ControleAcessoController');
    Route::resource('recebimento-fisico', 'RecebimentoFisicoController');
    Route::get('/recebimento-fisico/{id}/impressao', 'RecebimentoFisicoController@impressao')
    ->name('recebimento-fisico.impressao');
    ...
    Route::resource('etiqueta-modelos', 'EtiquetaModeloController');

    Route::get('etiqueta-modelos/{id}/editor', 'EtiquetaModeloController@editor')->name('etiqueta-modelos.editor');
    Route::post('etiqueta-modelos/{id}/salvar-layout', 'EtiquetaModeloController@salvarLayout')->name('etiqueta-modelos.salvar-layout');

    Route::get('etiqueta-modelos/{id}/selecionar-produtos', 'EtiquetaModeloController@selecionarProdutos')->name('etiqueta-modelos.selecionar-produtos');
    Route::post('etiqueta-modelos/{id}/imprimir-produtos', 'EtiquetaModeloController@imprimirProdutos')->name('etiqueta-modelos.imprimir-produtos');

    Route::get('etiquetas', 'EtiquetaImpressaoController@index')
    ->name('etiquetas.index');

    Route::post('etiquetas/imprimir', 'EtiquetaImpressaoController@imprimir')
    ...
    Route::resource('ponto-configuracao', 'PontoConfiguracaoController');
    ...
    Route::get('clientes-reajuste', 'ClienteController@reajuste')->name('clientes.reajuste');
    Route::post('clientes-reajuste-update', 'ClienteController@reajusteUpdate')->name('clientes-reajuste.update');
    ...
    Route::resource('ponto-relatorio', 'PontoRelatorioController');
    Route::resource('ponto-jornada', 'PontoJornadaController');
    Route::resource('ponto-funcionario', 'PontoFuncionarioController');
    Route::resource('ponto-registro', 'PontoRegistroController');
    Route::resource('ponto-ajuste', 'PontoAjusteController');

    Route::get('/ponto-ajuste', 'PontoAjusteController@index')->name('ponto-ajuste.index');
    Route::get('/ponto-ajuste/create/{registro_id}', 'PontoAjusteController@create')->name('ponto-ajuste.create');
    Route::post('/ponto-ajuste/store/{registro_id}', 'PontoAjusteController@store')->name('ponto-ajuste.store');
    Route::get('/ponto-ajuste/show/{id}', 'PontoAjusteController@show')->name('ponto-ajuste.show');
    ...
    Route::get('/estoque-data', 'EstoqueController@estoqueData')->name('estoque.data');
    ...
    Route::group(['prefix' => 'produto-composto'], function () {
        ...
        Route::get('/{id}/print', 'ProdutoCompostoController@print')->name('produto-composto.print');
    });

    Route::get('/produtos/{id}/composicao-completa', 'ProdutoCompostoController@composicaoCompleta')
    ->name('produtos.composicao-completa');
    ...
    Route::get('/apuracao-mensal/pdf/{apuracao_id}', 'ApuracaoMensalController@pdf')->name('apuracao-mensal.pdf');
    ...
    Route::get('conta-receber-imprimir-lote', 'ContaReceberController@imprimirComprovanteLote');
    ...
    Route::delete('/pedidos-cardapio-remover-todos-balanca', 'PedidoCardapioController@removerTodosBalanca')
    ->name('pedidos-cardapio.remover-todos-balanca');
    Route::post('pedidos-cardapio-finalizar-parcial/{id}', 'PedidoCardapioController@finalizarParcial')->name('pedidos-cardapio.finalizar-parcial');
    ...
    Route::resource('recorrencias', 'RecorrenciaController');
    Route::resource('recorrencia-cobrancas', 'RecorrenciaCobrancaController')->only([
        'index', 'show', 'destroy'
    ]);

    Route::post('recorrencias/{id}/gerar-cobranca', 'RecorrenciaController@gerarCobranca')
    ->name('recorrencias.gerar-cobranca');
    Route::post('recorrencia-cobrancas/{id}/marcar-pago', 'RecorrenciaCobrancaController@marcarPago')
    ->name('recorrencia-cobrancas.marcar-pago');
    Route::post('recorrencia-cobrancas/{id}/cancelar', 'RecorrenciaCobrancaController@cancelar')
    ->name('recorrencia-cobrancas.cancelar');
    Route::get('recorrencias/{id}/editar-cobranca', 'RecorrenciaController@edit')
    ->name('recorrencia-cobrancas.edit');

    Route::resource('recorrencia-regra-comunicacao', 'RecorrenciaRegraComunicacaoController');
    Route::resource('recorrencia-contrato-modelos', 'RecorrenciaContratoModeloController');
    ...
    Route::group(['prefix' => 'orcamentos'], function () {
        ...
        Route::get('imprimir-80mm/{id}', 'OrcamentoController@imprimir80mm')->name('orcamentos.imprimir80');
        ...
        Route::get('ordem-producao/{id}', 'OrcamentoController@ordemProducao')->name('orcamentos.ordem-producao');
    });
    ...
    Route::group(['prefix' => 'frontbox'], function () {
        ...
        Route::get('/create4', 'FrontBoxController@create4')->name('frontbox.create4');
    });
    ...
    Route::group(['prefix' => 'ordem-servico'], function () {
        ...
        Route::get('/gerar-pdv/{id}', 'OrdemServicoController@gerarPdv')->name('ordem-servico.gerar-pdv');
        ...
        Route::put('/{id}/desconto-produtos', 'OrdemServicoController@updateDescontoProdutos')->name('ordem-servico.update-desconto-produtos');
    });
    ...
    Route::get('/ordem-producao-impressao-tecnica/{id}', 'OrdemProducaoController@impressaoTecnica')->name('ordem-producao.impressao-tecnica');
    Route::post('/ordem-producao-config', 'OrdemProducaoController@config')->name('ordem-producao.config');

    Route::post('/ordem-producao/{id}/upload-imagens', 'OrdemProducaoController@uploadImagens')->name('ordem-producao.upload-imagens');
    Route::delete('/ordem-producao/imagem/{id}', 'OrdemProducaoController@removerImagem')->name('ordem-producao.remover-imagem');
    Route::get('/ordem-producao-gerar-venda/{id}', 'OrdemProducaoController@gerarVenda')->name('ordem-producao.gerar-venda');
    // Route::put('/ordem-producao-encerrar/{id}', 'OrdemProducaoController@encerrar')->name('ordem-producao.encerrar');

    Route::get('/ordem-producao-liberar/{id}', 'OrdemProducaoController@liberar')->name('ordem-producao.liberar');
    Route::get('/ordem-producao-iniciar/{id}', 'OrdemProducaoController@iniciar')->name('ordem-producao.iniciar');
    Route::get('/ordem-producao-finalizar/{id}', 'OrdemProducaoController@finalizar')->name('ordem-producao.finalizar');
    Route::get('/ordem-producao-encerrar/{id}', 'OrdemProducaoController@encerrar')->name('ordem-producao.encerrar');
    Route::get('/ordem-producao-simular-custos/{id}', 'OrdemProducaoController@simularCustos')->name('ordem-producao.simular-custos');

    Route::get('/app-qrcode', 'AppQrCodeController@index')->name('app-qrcode');
    Route::get('/app-qrcode-image', 'AppQrCodeController@qrCodeImage')->name('app-qrcode-image');

    Route::resource('motivo-refugo', 'MotivoRefugoController');
    
    Route::get('/apontamento-producao', 'ApontamentoProducaoController@index')->name('apontamento-producao.index');
    Route::get('/apontamento-producao/{id}', 'ApontamentoProducaoController@show')->name('apontamento-producao.show');
    Route::post('/apontamento-producao', 'ApontamentoProducaoController@store')->name('apontamento-producao.store');
    Route::get('/apontamento-producao-finalizar-operacao/{id}', 'ApontamentoProducaoController@finalizarOperacao')->name('apontamento-producao.finalizar-operacao');
    
    Route::resource('roteiro-producao', 'RoteiroProducaoController');
    ...
    Route::group(['prefix' => 'relatorios'], function () {
        ...
        Route::get('relatorio-movimentacoes', 'RelatorioController@movimentacoes')->name('relatorios.movimentacoes');
...
Route::resource('configuracao', 'ConfigController')->names('config');
Route::get('config-delete-logo', 'ConfigController@removerLogo')->name('config.delete-logo');
Route::get('config-delete-certificado', 'ConfigController@removerCertificado')->name('config.delete-certificado');
